...
fn session_summary(
    ...
    let resume_command = resume_command.map(|cmd| cmd.replacen("codex ", "xcodex ", 1));
    Some(SessionSummary {
        usage_line,
        resume_command,
    })
...
impl App {
    ...
    async fn handle_event(
        ...
        match event {
            ...
            AppEvent::UpdateFooterStatusOptions {
                show_model,
                show_git_branch,
                show_worktree,
            } => {
                ...
                self.chat_widget.set_footer_status_options(
                    show_model,
                    show_git_branch,
                    show_worktree,
                );
            ...
            AppEvent::PersistFooterStatusOptions {
                show_model,
                show_git_branch,
                show_worktree,
            } => {
                ...
                match ConfigEditsBuilder::new(&self.config.codex_home)
                    ...
                    .with_edits([
                        ConfigEdit::SetPath {
                            segments: vec!["tui".to_string(), "status_bar_show_model".to_string()],
                            value: toml_edit::value(show_model),
                        },
                        ConfigEdit::SetPath {
                            segments: vec![
                                "tui".to_string(),
...
"#;
    ...
    async fn backtrack_selection_with_duplicate_history_targets_unique_turn() {
        ...
        let make_header = |is_first| {
            ...
            let collaboration_mode = app.chat_widget.current_collaboration_mode().clone();
            let is_collaboration =
                collaboration_mode.mode != codex_protocol::config_types::ModeKind::Default;
            Arc::new(new_session_info(
                app.chat_widget.config_ref(),
                app.chat_widget.current_model(),
                event,
    ...
    async fn session_summary_prefers_name_over_id() {
        ...
        assert_eq!(
            summary.resume_command,
            Some("xcodex resume my-session".to_string())
        );
    }
}
