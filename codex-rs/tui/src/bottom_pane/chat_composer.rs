...
pub(crate) struct ChatComposer {
    ...
    is_zellij: bool,
    footer_model_name: Option<String>,
...
impl ChatComposer {
    ...
    pub(crate) fn set_footer_status_options(
        ...
        self.show_footer_model = show_model;
                ...
                if let Some(sel) = popup.selected_item() {
                    ...
                    match sel {
                        ...
                        CommandItem::BuiltinText {
                            ...
                            {
                                self.textarea.set_text_clearing_elements(&desired);
                        ...
                        CommandItem::ArgValue {
                            ...
                            self.textarea.set_text_clearing_elements(&next_text);
                    ...
                    match sel {
                        CommandItem::Builtin(cmd) => {
                            if cmd.supports_inline_args() {
                                let completed = format!("/{}", cmd.command());
                                if first_line.trim_end().starts_with(&completed) {
    ...
    fn footer_props(&self) -> FooterProps {
        ...
        FooterProps {
            ...
            footer_model_name: if self.show_footer_model {
                self.footer_model_name.clone()
            } else {
                None
            },
        ...
        match &mut self.active_popup {
            ...
            _ => {
                if is_editing_slash_command_name {
                    ...
                    let windows_degraded_sandbox_active = self.windows_degraded_sandbox_active;
    ...
    pub(crate) fn set_footer_model_name(&mut self, footer_model_name: Option<String>) -> bool {
        if self.footer_model_name == footer_model_name {
            return false;
        }
        self.footer_model_name = footer_model_name;
        true
    }
...
impl Renderable for ChatComposer {
    ...
    fn desired_height(&self, width: u16) -> u16 {
        ...
        let text_height = self.textarea.desired_height(inner_width).max(1);
        text_height
...
impl ChatComposer {
                        ...
                        match footer_props.mode {
                            FooterMode::ComposerEmpty | FooterMode::ComposerHasDraft => {
                                ...
                                Some(single_line_footer_layout(
                                    ...
                                    right_width,
                                    left_mode_indicator,
                                    footer_props.footer_model_name.as_deref(),
                                    show_cycle_hint,
                                    show_shortcuts_hint,
                                    show_queue_hint,
                                ))
    ...
    fn render_textarea(
        ...
        let textarea_style = base_style.fg(ratatui::style::Color::Reset);
...
mod tests {
    ...
    fn status_bar_keeps_worktree_visible_when_branch_is_similar_and_long() {
        ...
        composer.set_footer_status_options(
            /*show_model*/ false, /*show_branch*/ true, /*show_worktree*/ true,
        );
    ...
    fn status_bar_branch_and_worktree_snapshot_when_names_overlap() {
        snapshot_composer_state_with_width(
            ...
            |composer| {
                composer.set_footer_status_options(
                    /*show_model*/ false, /*show_branch*/ true,
                    /*show_worktree*/ true,
                );
                composer.set_status_bar_git_context(
                    Some("feat/project-level-settings".to_string()),
...
程序员 与 Unicode 同行";
    ...
    fn slash_subcommand_enter_runs_highlighted_suggestion_when_cursor_in_args() {
        ...
        assert_eq!(
            result,
            InputResult::CommandWithArgs(SlashCommand::Worktree, "doctor".to_string(), Vec::new(),)
        );
        assert!(composer.textarea.is_empty(), "composer should be cleared");
    }
    ...
    #[test]
    fn slash_popup_stays_open_while_typing_worktree_subcommands() {
        use tokio::sync::mpsc::unbounded_channel;
        ...
        composer.set_text_content("/worktree d".to_string(), Vec::new(), Vec::new());
        assert!(
            matches!(composer.active_popup, ActivePopup::Command(_)),
            "expected /worktree subcommand popup to stay open while typing args"
        );
    }
    ...
    fn slash_popup_run_on_enter_theme_subcommand_dispatches_command_with_args() {
        ...
        composer.set_text_content("/theme help".to_string(), Vec::new(), Vec::new());
        ...
        assert_eq!(
            result,
            InputResult::CommandWithArgs(SlashCommand::Theme, "help".to_string(), Vec::new(),),
    ...
    fn slash_popup_run_on_enter_worktree_subcommand_dispatches_command_with_args() {
        ...
        composer.set_text_content("/worktree doctor".to_string(), Vec::new(), Vec::new());
        assert!(matches!(composer.active_popup, ActivePopup::Command(_)));
