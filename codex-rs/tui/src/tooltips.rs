...
pub(crate) mod announcement {
    ...
    pub(crate) fn parse_announcement_tip_toml(
        ...
        parse_announcement_tip_toml_with_target(text, "cli", plan)
    }
    ...
    pub(crate) fn parse_announcement_tip_toml_for_target(
        ...
        parse_announcement_tip_toml_with_target(text, target_app, None)
    }

    fn parse_announcement_tip_toml_with_target(
        text: &str,
        target_app: &str,
        plan: Option<PlanType>,
    ) -> Option<String> {
