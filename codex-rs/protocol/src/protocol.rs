...
impl Op {
    pub fn kind(&self) -> &'static str {
        match self {
            ...
            Self::TerminateUnifiedExecSession { .. } => "terminate_unified_exec_session",
            Self::TerminateAllUnifiedExecSessions => "terminate_all_unified_exec_sessions",
            ...
            Self::McpRetry { .. } => "mcp_retry",
            Self::McpLoad { .. } => "mcp_load",
            Self::McpSetStartupTimeout { .. } => "mcp_set_startup_timeout",
            Self::InterAgentCommunication { .. } => "inter_agent_communication",
            Self::OverrideTurnContext { .. } => "override_turn_context",
            Self::SetAutoCompact { .. } => "set_auto_compact",
...
pub use self::xcodex_exclusion_summary::ExclusionCounts;
pub use self::xcodex_exclusion_summary::ExclusionLayerCounts;
pub use self::xcodex_exclusion_summary::ExclusionSourceCounts;
pub use self::xcodex_exclusion_summary::ExclusionSummaryEvent;
pub use self::xcodex_exclusion_summary::ExclusionToolCount;
...
mod tests {
    ...
    fn token_usage_info_new_or_append_updates_context_window_when_provided() {
        ...
        let info = TokenUsageInfo::new_or_append(&initial, &last, Some(128_000), Some(128_000))
