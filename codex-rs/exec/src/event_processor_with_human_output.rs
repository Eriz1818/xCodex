...
impl EventProcessor for EventProcessorWithHumanOutput {
    fn print_config_summary(
        ...
        eprintln!("xtreme-Codex v{VERSION} (research preview)\n--------");
        ...
        match notification {
            ...
            ServerNotification::McpServerStatusUpdated(notification) => {
                let status_text = match notification.status {
                    ...
                    codex_app_server_protocol::McpServerStartupState::Ready => "ready".to_string(),
                    codex_app_server_protocol::McpServerStartupState::Cancelled => {
                        "cancelled".to_string()
                    }
                    codex_app_server_protocol::McpServerStartupState::Failed => notification
                        .error
