...
HookPayload = TypedDict(
    "HookPayload",
    {
        ...
        "cwd": Required[str],
        "detail_decision": NotRequired[Union[None, Union[Literal["aborted"], Literal["approved"], Literal["approved-for-session"], Literal["approved-with-amendment"], Literal["canceled"], Literal["denied"]]]],
        ...
        "outcome": NotRequired[Union[None, Union[Literal["accepted"], Literal["declined"]]]],
