...
mod tests {
    ...
    fn temp_home(prefix: &str) -> io::Result<PathBuf> {
    ...
    #[test]
    fn plan_external_includes_expected_files_and_config() -> io::Result<()> {
    ...
    #[test]
    fn plan_pyo3_includes_hook_file_and_notes() -> io::Result<()> {
    ...
    #[test]
    fn apply_external_writes_expected_files() -> io::Result<()> {
        let home = temp_home("hooks-samples-apply-external")?;
        apply_install_samples(&home, HookSample::External, false)?;
